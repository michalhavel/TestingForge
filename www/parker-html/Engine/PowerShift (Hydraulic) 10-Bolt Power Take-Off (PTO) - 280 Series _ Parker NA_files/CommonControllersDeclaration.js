...
/** 
* Declares a new refresh controller for the Quote Cart display.
*/
wc.render.declareRefreshController({
id: "QuoteCartDisplayController",
renderContext: wc.render.getContextById("QuoteCartPaginationDisplay_Context"),
url: "",
formId: ""
/** 
* Refreshs the Quote cart area when an update to the order is made, 
* such as add/remove items or update quantity/promotions etc.
* This function is called when a modelChanged event is detected. 
* 
* @param {string} message The model changed event message
...
*/
,postRefreshHandler: function(widget) {
resetRequest(); //quote cart is refreshed, give the control to shopper...
read_more.init();
tooltip.init();
var controller = this;
var renderContext = this.renderContext;
...
/** 
* Declares a new refresh controller for the Quote Cart pagination display.
*/
wc.render.declareRefreshController({
id: "QuoteCartPaginationDisplayController",
renderContext: wc.render.getContextById("QuoteCartPaginationDisplay_Context"),
url: "",
formId: ""
/** 
