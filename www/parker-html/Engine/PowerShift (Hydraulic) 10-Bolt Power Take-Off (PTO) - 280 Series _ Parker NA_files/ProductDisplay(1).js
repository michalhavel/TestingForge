 ...
 */
			 ...
			 */			
			function changeThumbNail(angleImgId,imgsrc,DivIdToDisplay,fullImageCount){
					...
					for(var i=0;i<=fullImageCount;i++)
						{
						document.getElementById('zoomTest'+i).style.display='none';
						document.getElementById('productAngleImg'+i).setAttribute("class", "off");
						}
					document.getElementById(DivIdToDisplay).style.display='block';
				
					document.getElementById(angleImgId).setAttribute("class", "highlightImage off");
			}
