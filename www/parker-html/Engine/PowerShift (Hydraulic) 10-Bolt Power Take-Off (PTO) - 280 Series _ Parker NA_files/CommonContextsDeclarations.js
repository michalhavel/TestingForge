...
/**
 * Declares a new render context for Quote Cart with pagination,
 * and initializes it with the beginning index value. 
 */
wc.render.declareContext("QuoteCartPaginationDisplay_Context",{},""),
/**
 ...
 * Declares a new render context for the processed orders status display.
 */
wc.render.declareContext("ProcessedQuotesStatusDisplay_Context",{beginIndex: "0", selectedTab: "PreviouslyProcessed"},""),
 ...
 * Declares a new render context for top category tall double espot.
 */
wc.render.declareContext("validateShippingAddressAreaContext",{nextServiceId: "0",validateServiceResponse: "ShippingAndBilling",originalAddress: "",suggestedAddress:""},"")
